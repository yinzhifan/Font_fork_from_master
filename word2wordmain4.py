...
"""
# version 4 : deleting / increasing convolutional layers
...
layer2 = HiddenLayer(
        np.random.RandomState(np.random.randint(10000)),
        input=layer2_input,
        n_in=nkerns[1] * len(input_letter) * 18 * 18,
        n_out=50,
...
"""st2 = 'c4lasfi-'+ str(learning_rate) + '-' + str(n_train_batches) + '-' + str(n_epochs) +'-'+ str(batch_size)
text_index = 0
